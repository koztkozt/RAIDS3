...
class AdvGAN_Uni_Attack:
    ...
    def train_batch(self, x, angle_speed, target, noise_x):
        # optimize D
        for i in range(1):
    ...
    def train(self, train_dataset, epochs, noise_name=None):
        ...
        for epoch in range(1, epochs + 1):
            ...
            for _, sample in enumerate(train_dataloader, start=0):
                ...
                im_noise_tr = np.tile(self.im_noise, (self.batch_size, 1, 1, 1))
                ...
                loss_D_batch, loss_G_fake_batch, loss_perturb_batch, loss_adv_batch = self.train_batch(
                    batch_x, angle_speed, inv_target, noise_x
                )
