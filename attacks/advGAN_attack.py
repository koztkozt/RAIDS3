...
def advGAN_Attack(dataset_name, stage1, stage2, train_dataset, config, universal=False):
    ...
    if not universal:
        advGAN = AdvGAN_Attack(device, stage1, stage2, dataset_name, image_nc, BOX_MIN, BOX_MAX, batch_size)
    else:
        advGAN = AdvGAN_Uni_Attack(
            device, stage1, stage2, dataset_name, image_size, image_nc, BOX_MIN, BOX_MAX, batch_size
        )
